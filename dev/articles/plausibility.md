...
1.  [`mw_plausibility_check_wfhz()`](https://mphimo.github.io/mwana/dev/dev/reference/mw_plausibility_check_wfhz.md)
...
2.  [`mw_plausibility_check_wfhz()`](https://mphimo.github.io/mwana/dev/dev/reference/mw_plausibility_check_wfhz.md)
...
[`help("mw_wrangle_age")`](https://mphimo.github.io/mwana/dev/dev/reference/mw_wrangle_age.md)
or
[`help("mw_wrangle_wfhz")`](https://mphimo.github.io/mwana/dev/dev/reference/mw_wrangle_wfhz.md)
in `R` console.
