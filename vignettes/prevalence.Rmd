...
The standard deviation and the age ratio test results are used to control the prevalence analysis flow in this way: 
  ...
  + If the standard deviation is not problematic but the age ratio test is problematic, the SMART MUAC tool age-weighting approach is applied in either 
  functions
