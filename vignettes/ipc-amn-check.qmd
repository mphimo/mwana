...
Now that we got acquainted with the dataset, we can proceed to executing the task. To achieve this, we simply do:
...
1. A vector containing the categories for which the analysis should be summarised. More than one vector can be specified, separated by `,`. 
