...
testthat::test_that("mw_estimate_age_weighted_prev_muac() works as expected", {
  ### Input data ----
  x <- mfaz.01 |>
    mw_wrangle_age(
      age = age
...
testthat::test_that("When MUAC is not in centimetres, the function stops execution", {
